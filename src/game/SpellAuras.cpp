...
m_auraSlot(MAX_AURAS), m_auraFlags(AFLAG_NONE), m_effectMask(0), m_auraLevel(1), m_procCharges(0),
...
void SpellAuraHolder::BuildUpdatePacket(WorldPacket& data) const
{
    ...
    {
        data << uint8(MAX_EFFECT_INDEX);  // effect count
