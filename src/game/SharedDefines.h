...
enum SkillType
{
    ...
    SKILL_PET_PRIMAL_FIRE_ELEM     = 962,
    SKILL_PET_PRIMAL_EARTH_ELEM    = 963,
...
enum BattleGroundTypeId
{
    ...
    BATTLEGROUND_RBG_25v25     = 102,                       // rated battleground 25v25
    BATTLEGROUND_TP            = 108,                       // 4.x
    BATTLEGROUND_BG            = 120,                       // 4.x
...
enum BattleGroundQueueTypeId
{
    ...
    BATTLEGROUND_QUEUE_TK       = 12,
    BATTLEGROUND_QUEUE_CT       = 13,
    BATTLEGROUND_QUEUE_SM       = 14
};
