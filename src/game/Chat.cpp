...
ChatCommand* ChatHandler::getCommandTable()
{
    ...
    static ChatCommand mmapCommandTable[] =
    {
        ...
        { "on",             SEC_ADMINISTRATOR,  false, &ChatHandler::HandleMmapOn,                     "", NULL },
        { "off",            SEC_ADMINISTRATOR,  false, &ChatHandler::HandleMmapOff,                    "", NULL },
        { NULL,             0,                  false, NULL,                                           "", NULL }
    };
    ...
    static ChatCommand modifyCommandTable[] =
    {
        ...
        { "chi",            SEC_MODERATOR,      false, &ChatHandler::HandleModifyChiCommand,           "", NULL },
    ...
    static ChatCommand reloadCommandTable[] =
    {
        ...
        { "opcodes",        SEC_ADMINISTRATOR,  true,  &ChatHandler::HandleReloadOpcodesCommand,       "", NULL },
