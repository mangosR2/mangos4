...
void World::LoadConfigSettings(bool reload)
{
    ...
    setConfig(CONFIG_FLOAT_RATE_POWER_CHI,               "Rate.Chi", 1.0f);
...
std::string World::GetRealmName(uint32 realmId)
{
    std::string name;
/* FIXME - speedup
    if (realmId == GetRealmName(getConfig(CONFIG_UINT32_REALMID)))
    {
        name = m_realmName
    }
*/
